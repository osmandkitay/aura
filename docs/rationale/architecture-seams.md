...
Existing AURA 2.0 documents are accepted as input only when they already preserve that finalized canonical order and the matching finalized ids, and publish does not rescue malformed input.
